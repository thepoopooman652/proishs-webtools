...
// Retrieve API keys from environment variables (set in .htaccess or server config).
$authToken = getenv('MAIN_API_KEY');
$uploadToken = getenv('UPLOAD_API_KEY');
$uploadTokenPrivate = getenv('PRIVATE_API_UPLOAD_KEY');
